...
class ArgosTranslationService(PrimaryTranslationService):
    ...
    def translate(self, term: str, source_lang: str, target_lang: str) -> str | None:
        try:
            translated = translators.translate_text(term, translator="argos", from_language=source_lang, to_language=target_lang)

            # In case someone passes "is_detail_result=True" to the class, the result is a dict.
