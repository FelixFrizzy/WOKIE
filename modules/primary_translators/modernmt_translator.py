...
class ModernMTTranslationService(PrimaryTranslationService):
    def __init__(self, *, logger = None):
        # If no logger passed, use a module‐level logger
        self.logger: logging.Logger = logger or logging.getLogger(__name__)
        self.service_name = "modernmt"
    ...
    def translate(self, term: str, source_lang: str, target_lang: str) -> str | None:
        ...
        try:
            translated = translators.translate_text(term, translator="modernMt", from_language=lang_mapping[source_lang], to_language=lang_mapping[target_lang])
            return(translated)
...
if __name__ == "__main__":
    ...
    translator = ModernMTTranslationService()
    term = "hello world"
    source_lang = "en"
    target_lang = "es-ES"
    try:
